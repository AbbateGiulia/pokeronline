...
<div class="container">
	...
	<c:set var= "tavolo" value="${requestScope.tavoloAttribute}"/>
      	...
      	<form class="form-horizontal" action="${pageContext.request.contextPath}/special/ExecuteUpdateTavoloServlet" method="post">
      	
      	<input class="form-control" type="text" id="tavoloId" name="tavoloId" value="${tavolo.id}" >
