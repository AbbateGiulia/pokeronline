...
<div class="container">
	...
	<c:set var= "tavolo" value="${requestScope.tavoloAttribute}"/>
      	...
      	<form class="form-horizontal" action="${pageContext.request.contextPath}/special/ExecuteUpdateTavoloServlet"  id= "form" method="post">
      	
      	<input class="form-control" type="hidden" id="tavoloId" name="tavoloId" value="${tavolo.id}" >
			...
			<div class="form-group">
		      ...
		      <div class="col-sm-offset-2 col-sm-10">
		        <button type="submit" class="btn btn-success btn-md">Effetua Aggiornamento</button>
		      </div>
		    </div>
